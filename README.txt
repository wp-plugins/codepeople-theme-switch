...
**Mobile Theme Switch** checks the "user agent" of the browser to identify the device used for browsing. If a mobile device is detected (phone, table, ebook reader or games console) the **Mobile Theme Switch** plugin, checks the device's screen, and activates the correct theme, depending of conditions.
...
**To install Mobile Theme Switch, follows the steps below:**
